...
@WebServlet("/DisplayServletForBooking")
public class DisplayServletForBooking extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public DisplayServletForBooking() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println(
				"<form action=\"AddMovieShow.jsp\" method=\"post\"><input type=\"submit\" value=\"Add Movie Show\" name=\"Add Movie Show\"></form>");
